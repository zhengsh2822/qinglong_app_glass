...
class SelectionFollowTextField extends StatefulWidget {
  ...
  @override
  State<SelectionFollowTextField> createState() =>
      _SelectionFollowTextFieldState();
}

class _SelectionFollowTextFieldState extends State<SelectionFollowTextField> {
  ...
  // ── 诊断 4：controller 复用检查（每次 build 后打印一次）────
  @override
