              ...
              child: Column(
                ...
                children: [
                  ...
                  SettingsSwitchRow(
                    ...
                    title: "赛博模式",
                    value:
                        SpUtil.getInt(spThemeStyle, defValue: modeLight) ==
                        modeCyber,
                    onChanged: (open) async {
                      SpUtil.putBool(spThemeFollowSystem, false);
                      if (open) {
                        ref.read(themeProvider.notifier).changeTheme(modeCyber);
                      } else {
                  ...
                  SettingsSwitchRow(
                    ...
                    title: "跟随系统",
                    value: SpUtil.getBool(spThemeFollowSystem, defValue: false),
                    onChanged: (open) async {
