          ...
          child: Column(
            ...
            children: [
              _buildSection("新增功能与设计", [
                ...
                "仪表盘对齐 Web 端：新增 7 日趋势自绘折线图、今日耗时 Top5、执行次数 Top5、标签统计、实时运行态（含 PID）、系统资源，老版本服务端自动隐藏不支持的卡片",
                "脚本搜索能力补全：列表页常驻胶囊搜索栏（300ms 防抖递归过滤）；查看/编辑页弹出式搜索卡片",
                "日志/任务详情/环境变量详情/订阅详情/代码高亮等可复制区域启用 iOS 风格文本选择放大镜（11 个文件）",
                "京东助手独立模块：独立青龙面板登录、自动获取 clientId/clientSecret、Cookie 上传前校验 pt_key/pt_pin",
